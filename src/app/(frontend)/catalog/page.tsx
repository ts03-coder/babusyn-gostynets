  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Побудова URL для товарів із параметрами фільтрації
        ...
        // Додаємо параметр categories лише якщо є вибрані категорії
    ...
    fetchData();
  }, [currentPage, searchQuery, selectedCategories, priceRange, onlyOnSale, sortBy]);
